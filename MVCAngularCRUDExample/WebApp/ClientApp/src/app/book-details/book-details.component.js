...
var BookDetailsComponent = /** @class */ (function () {
    function BookDetailsComponent(router, route, http) {
        this.router = router;
        this.route = route;
        this.http = http;
        this.book = {};
    ...
    BookDetailsComponent.prototype.getBookDetail = function (id) {
        var _this = this;
        this.http.get('/api/books/' + id).subscribe(function (data) {
            _this.book = data;
        });
    };
    BookDetailsComponent.prototype.deleteBook = function (id) {
        var _this = this;
